...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		int number = this.getNumVertices();

		ArrayList<Integer> degreeSequence = new ArrayList<Integer>();

		for (int i = 0;i < number; i++) {
			List<Integer> outNeighbors = this.getNeighbors(i);
			List<Integer> inNeighbors = this.getInNeighbors(i);
			degreeSequence.add(outNeighbors.size() + inNeighbors.size());
		}
	...
	public static void main (String[] args) {
		...
		GraphLoader.createIntersectionsFile("data/maps/pozniaki.map", "data/intersections/pozniaki.intersections");
		...
		System.out.println("****");
		System.out.println("Roads / intersections / UCSD:");
		GraphAdjList graphUcsdFromFile = new GraphAdjList();
		GraphLoader.loadRoadMap("data/maps/ucsd.map", graphUcsdFromFile);
		System.out.println(graphUcsdFromFile);

		System.out.println("****");

		System.out.println("****");
		System.out.println("Roads / intersections / Pozniaki:");
		GraphAdjList graphPozniakiFromFile = new GraphAdjList();
		GraphLoader.loadRoadMap("data/maps/pozniaki.map", graphPozniakiFromFile);
		System.out.println(graphPozniakiFromFile);
